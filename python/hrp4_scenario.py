...
class Scenario:
	...
	def __init__(self, robot):
		...
		(taskGripperZ, positionZ) = 	createFeaturePointToPoint('positionZ', r_gripperZpos, heightZ)
		...
		(taskGripperXY, positionXY) = createFeaturePointToPoint('positionXY', r_gripperXY, posXY)
